...
function ParentHome({ dashboard, pendingQuestCount, pendingRewardCount, onEnrollHero, onManageHero, onOpenReview }: { dashboard: ParentDashboardSummary; pendingQuestCount: number; pendingRewardCount: number; onEnrollHero: () => void; onManageHero: (hero: ManagedHeroAccount) => void; onOpenReview: () => void }) {
