...
export function RewardAdmin({ rewards, retiredRewards = [], catalog = [], onSave, onRemove, onRestore }: { rewards: Reward[]; retiredRewards?: Reward[]; catalog?: Reward[]; onSave: (reward: Reward) => boolean | Promise<boolean>; onRemove: (id: string) => boolean | Promise<boolean>; onRestore: (id: string) => boolean | Promise<boolean> }) {
...
const styles = StyleSheet.create({
  ...
  summary: { flexDirection: 'row', alignItems: 'center', gap: 13 }, summaryValue: { color: colors.green, fontSize: 30, fontWeight: '900' }, cardTitle: { color: colors.ink, fontSize: 16, fontWeight: '900' }, rewardCard: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 13 }, emojiBox: { width: 50, height: 50, borderRadius: 15, backgroundColor: colors.cream, alignItems: 'center', justifyContent: 'center' }, emoji: { fontSize: 27 }, copy: { flex: 1, gap: 2 }, rewardTitle: { color: colors.ink, fontSize: 15, fontWeight: '900' }, cost: { color: colors.green, fontWeight: '900', fontSize: 11, marginTop: 3 }, actions: { gap: 7 }, iconButton: { width: 35, height: 35, borderRadius: 10, backgroundColor: colors.cream, alignItems: 'center', justifyContent: 'center' }, libraryAdd: { paddingHorizontal: 12, paddingVertical: 9, borderRadius: 10, backgroundColor: colors.green }, libraryAddText: { color: colors.white, fontSize: 10, fontWeight: '900' }, restoreButton: { paddingHorizontal: 12, paddingVertical: 9, borderRadius: 10, backgroundColor: colors.navy }, restoreText: { color: colors.white, fontSize: 10, fontWeight: '900' },
